...
@implementation OldCustomAlertView
...
- (void)customIOS7dialogButtonTouchUpInside: (OldCustomAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
...
- (UIView *)createContainerView
{
    ...
    UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(0, dialogContainer.bounds.size.height - btnHeight - btnSpacerHeight, dialogContainer.bounds.size.width, btnSpacerHeight)];
...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        [closeButton setFrame:CGRectMake(i * buttonWidth, container.bounds.size.height - btnHeight, buttonWidth, btnHeight)];
...
- (void)addImageButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonImages count]; i++) {
        ...
        [closeButton setFrame:CGRectMake(i * buttonWidth + 35, container.bounds.size.height - btnHeight, 50, 50)];
...
- (CGSize)countDialogSize
{
    ...
    CGFloat dialogHeight = containerView.frame.size.height + btnHeight + btnSpacerHeight;
...
- (CGSize)countScreenSize
{
    if (buttonTitles!=NULL && [buttonTitles count] > 0) {
        btnHeight       = kCustomIOSAlertViewDefaultbtnHeight;
        btnSpacerHeight = kCustomIOSAlertViewDefaultbtnSpacerHeight;
    } else {
        btnHeight = 0;
        btnSpacerHeight = 0;
    }
...
- (void)removeNotificationCenterObserver {
    NSLog(@"");
    NSLog(@"removeNotificationCenterObserver");
...
- (void)deviceOrientationDidChange: (NSNotification *)notification
{
    ...
    NSLog(@"isKbShowing: %d", isKbShowing);
