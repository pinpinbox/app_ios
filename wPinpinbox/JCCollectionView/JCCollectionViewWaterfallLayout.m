...
- (void)setup
{
    ...
    self.sectionInset = UIEdgeInsetsMake(0.0f, 25.0f, 0.0f, 10.0f);
...
{
    NSLog(@"");
    NSLog(@"JCCollectionViewWaterfallLayout");
    NSLog(@"prepareLayout");
    ...
    for (NSInteger section = 0; section < numberOfSections; section++) {
        ...
        NSLog(@"sectionInset: %@", NSStringFromUIEdgeInsets(sectionInset));
        ...
        if (headerHeight > 0) {
            ...
            NSLog(@"header self.contentHeight setup");
        }
...
- (CGFloat)minimumLineSpacingForSection:(NSInteger)section
{
    NSLog(@"");
    NSLog(@"JCCollectionViewWaterfallLayout");
    NSLog(@"minimumLineSpacingForSection");
