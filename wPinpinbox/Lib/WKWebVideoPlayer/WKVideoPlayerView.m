...
- (NSString *)getFBVideoString:(NSString *)link {
    ...
    NSString *src = @"<html><head><style type='text/css'> body { margin: 0; width:100%%; height:100%%; background-color:#000000; }</style></head><body><div id=\"fb-root\"></div><script> window.fbAsyncInit = function() {FB.init({appId      : '472973216191275',xfbml:true,version:'v2.6'});var my_video_player;FB.Event.subscribe('xfbml.ready', function(msg) {if (msg.type === 'video') {my_video_player = msg.instance; var myEventHandler = my_video_player.subscribe('startedPlaying', function(e) {webkit.messageHandlers.callbackHandler.postMessage(' VideoIsReady');}); my_video_player.play();}});};(function(d, s, id) {  var js, fjs = d.getElementsByTagName(s)[0];  if (d.getElementById(id)) return;  js = d.createElement(s); js.id = id;  js.src = \"https://connect.facebook.net/en_US/sdk.js\";  fjs.parentNode.insertBefore(js, fjs); }(document, 'script', 'facebook-jssdk')); function stopPlayer() { myEventHandler.removeListener('startedPlaying'); my_video_player.pause(); } </script> <div style='width:100%%;height:100%%;display: flex;vertical-align: middle;align-items:center;' ><div style='width:100%%; ' class=\"fb-video\" data-href=\"%@\" data-width=\"auto\" data-autoplay=\"true\" data-allowfullscreen=\"true\" data-show-text=\"false\"></div></body></html>";
