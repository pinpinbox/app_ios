...
//        [self addGestureRecognizer:_longPressRecognizer];
        ...
        self.itemBGHighlightedColor = [UIColor colorWithWhite: 1.0 alpha: 1.0].CGColor;
        //self.itemBGHighlightedColor = [UIColor colorWithRed: 255.0/255.0 green: 255.0/255.0 blue: 255.0/255.0 alpha: 1.0].CGColor;
...
- (CALayer*) layerWithImage:(UIImage*) image
{
    ...
    imageLayer.bounds = CGRectMake(0, 0, GHMenuItemSize*2/3 + 10, GHMenuItemSize*2/3 + 10);
